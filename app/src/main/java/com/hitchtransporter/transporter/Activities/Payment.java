...
public class Payment extends MasterActivity {
    ...
    public void initComponents() {
      ...
      //  balanceTv.setText(getString(R.string.charge) + getIntent().getStringExtra(AMOUNT));
...
//        params.put(AMOUNT, decimalFormatter(getIntent().getStringExtra(AMOUNT)));
        double d =   Math.round(Double.parseDouble(getIntent().getStringExtra(AMOUNT)) * 100);
        int i = (int) d;
