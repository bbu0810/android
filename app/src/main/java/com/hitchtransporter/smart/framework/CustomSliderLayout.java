...
/**
 * Created by ebiztrait321 on 18/7/17.
 */
     ...
     *
     */
    public class CustomSliderLayout extends RelativeLayout {
        ...
        public CustomSliderLayout(Context context, AttributeSet attrs, int defStyle) {
            ...
            mTransformerId = attributes.getInt(com.daimajia.slider.library.R.styleable.SliderLayout_pager_animation, com.daimajia.slider.library.SliderLayout.Transformer.Default.ordinal());
            ...
            attributes.recycle();
            setPresetIndicator(com.daimajia.slider.library.SliderLayout.PresetIndicators.Center_Bottom);
        ...
        public void setPresetTransformer(int transformerId){
            for(com.daimajia.slider.library.SliderLayout.Transformer t : com.daimajia.slider.library.SliderLayout.Transformer.values()){
         ...
         * @param ts
         */
        public void setPresetTransformer(com.daimajia.slider.library.SliderLayout.Transformer ts){
            //
        ...
        public void setPresetIndicator(com.daimajia.slider.library.SliderLayout.PresetIndicators presetIndicator){
