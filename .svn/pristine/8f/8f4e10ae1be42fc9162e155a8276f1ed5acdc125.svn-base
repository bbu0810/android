...
public class PagingProvider {
     ...
     *
     * @param pageCounter represented page counter
     */
     ...
     *
     * @param totalCount represented total count
     */
     ...
     *
     * @param hasNextPage represented isHashNextPage
     */
     ...
     *
     * @param totalPageCount represented total page counter
     */
     ...
     *
     * @param pageLimit represented page limit
     * @param total     represented total data
     */
    public void setPagingParams(int pageLimit, int total) {
        setTotalCount(total);
